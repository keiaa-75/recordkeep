...
public class SectionController {
    ...
    public String deleteSection(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage", "Section and all its related students and attendance records have been deleted successfully!");
        } catch (Exception e) {
            redirectAttributes.addFlashAttribute("errorMessage", "Error deleting section: " + e.getMessage());
        }
        return "redirect:/sections";
    }
